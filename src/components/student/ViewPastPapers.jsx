...
const ViewPastPapers = () => {
  ...
  const submit = async (e) => {
    ...
    const res = await fetch(`https://backend-three-nu.vercel.app/Pastpaper/paper/${course_title}/${paper_type}/${session}`, {
      method: "GET",
      headers: {
  ...
  const delcourse = async (_id) => {
    const res = await fetch(`https://backend-three-nu.vercel.app/Pastpaper/papers/${_id}`, {
      method: "GET",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
    ...
    <div className='maincontainer'>
      ...
      <div className='viewpastpapercontainer'>
        <form action='' method='GET'>
          ...
          <br />
          <select className='courseinput' name='course_title' id='' placeholder='' value={userData.course_title} onChange={handleinputs} required>
          ...
          <br />
          <select className='courseinput' name='paper_type' id='' value={userData.paper_type} onChange={handleinputs} placeholder='' required>
            <option value='' disabled selected hidden>
              Select Paper Type
            </option>
          ...
          <br />
          <select className='courseinput' name='session' id='' placeholder='' value={userData.session} onChange={handleinputs} required>
            <option value='' disabled selected hidden>
              Select Session
            </option>
