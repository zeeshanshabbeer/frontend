...
const DropForm = (props) => {
  ...
  const adddropform = async () => {
    const res = await fetch(`https://backend-three-nu.vercel.app/DropCourse/Drop_Form/${registrationId}`, {
      method: "GET",
      headers: {
  ...
  const rejectRequest = async (e) => {
    ...
    const res = await fetch("https://backend-three-nu.vercel.app/DropCourse/delete_DropRequest", {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        authorization: localStorage.getItem("BA_token"),
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    const res = await fetch("https://backend-three-nu.vercel.app/DropCourse/dropcoursess", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        authorization: localStorage.getItem("BA_token"),
